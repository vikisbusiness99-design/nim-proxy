...
def chat_completions():
    ...
    try:
        ...
        # UPDATED: Maximum capacity for DeepSeek R1 (64K tokens)
        requested_max_tokens = openai_request.get('max_tokens')
        if requested_max_tokens is None or requested_max_tokens < 100:
            max_tokens = 65536  # 64K - DeepSeek R1's maximum capacity
        else:
            max_tokens = min(requested_max_tokens, 65536)  # Cap at model max
